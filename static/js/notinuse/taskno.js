...
// THIS IS WHERE THE PROBLEM IS!! - SOMEWHERE IN THE IMPLEMENTATION OF THE LOOP
	var next = function() {
		if (stims.length===0) {
			BlockEnd();
		}
...
var ExperimentEnd = function() {
	...
	psiTurk.showPage('ExperimentEnd.html');
	$("body").focus().keydown(response_handler2); 
};
	...
	resubmit = function() {
		...
		psiTurk.saveData({
			success: function() {
                ...
                psiTurk.computeBonus('compute_bonus', function(){BlockFinish()}); 
			}, 
