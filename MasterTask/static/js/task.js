...
var pages = [
	"DOSPERTinstruct-1.html",
	"DOSPERTinstruct-2.html",
	"DOSPERTinstruct-3.html",
	"DOSPERTinstruct-ready.html",
...
var EBQuestionnaire = function() {
	...
	var finish = function() {
	    $("body").unbind("keydown", response_handler); // Unbind keys
	     psiTurk.showPage('HLpostquestionnaire.html');
	};
...
$(window).load( function(){
    psiTurk.doInstructions(
    	instructionPages, // a list of pages you want to display in sequence
    	function() { currentview = new HLExperiment(); } // what you want to do when you are done with instructions
    );
});
...
var DospertStart = function() { 
	psiTurk.showPage('DOSPERTinstruct-1.html');
};

var Dospert1 = function() { 
	psiTurk.showPage('DOSPERTinstruct-2.html'); 
};

var Dospert2 = function() { 
	psiTurk.showPage('DOSPERTinstruct-3.html'); 
};

var Dospert3 = function() { 
	psiTurk.showPage('DOSPERTinstruct-ready.html');
};

var HLStart = function() { 
	psiTurk.showPage('HLinstruct-1.html')
};

var HL1 = function() { 
	psiTurk.showPage('HLinstruct-2.html');
};

var HL2 = function() { 
	psiTurk.showPage('HLinstruct-3.html');
};

var HL3 = function() { 
	psiTurk.showPage('HLinstruct-ready.html');
};
